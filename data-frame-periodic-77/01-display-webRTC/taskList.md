Notes From Veenus.
This code is created with Rob's code on webRTC. this task list is copied from his repository. which might be useful. but only reference. this code has been modified like producer & consumer. may be you can interpret like Client 1 as producer and client 2 as consumer.
Also removed video and audio when I added data.
